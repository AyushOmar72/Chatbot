...
function ChatSection() {
  ...
  return (
    <div className='hey' id="chatsection">
      ...
      <input onChange={(e)=>{setInput(e.target.value)}} className='input' type='text' placeholder='Enter a Prompt' value={input} ></input>
      
      <button className='sendbtn' onClick={()=>{sent(input)}}><LuSendHorizonal /> </button>
      <Darkmode/>
      </div>
